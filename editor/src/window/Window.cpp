...
namespace Editor
{
    ...
    Window::Window(const WindowOp &options)
    {
        ...
        m_window_instance = glfwCreateWindow(1280, 720, "Lotus Editor", nullptr, nullptr);
        if (m_window_instance == nullptr)
        {
            throw std::runtime_error{"Failed to create window"};
        }

        auto window = static_cast<GLFWwindow *>(m_window_instance);
