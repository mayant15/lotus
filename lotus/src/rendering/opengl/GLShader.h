...
namespace Lotus
{
    struct GLShader final : Shader
    {
        ...
        void SetDirectionalLight(const std::string& name, const LightInfo& options) const override;
        ...
        void SetDirLightArray(const std::string& name, const std::vector<LightInfo>& lights) const override;
